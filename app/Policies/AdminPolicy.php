...
class AdminPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function create(Admin $admin) //create
    {

        return $admin->hasPermissionTo('Create Admin')
            ? $this->allow()
            : $this->deny('This is can not Show Admins ');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, Admin $admin) //create
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, Admin $admin) //destroy
    {
        //
    }
