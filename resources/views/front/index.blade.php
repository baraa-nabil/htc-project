            ...
            <div class="col-lg-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('det', $article->id) }}" class="btn btn-primary">Learn More</a>
                    </div>
                </div>
            </div>
            @endforeach
...
<section class="gray-sec">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    {{-- {{ asset('storage/images/slider/' . $slider->image ?? "") }} --}}
                    <div class="card-body">
                        <h4 class="card-title">
        ...
        <div align="center"><a class="btn btn-success" href="{{ route('all',$category->id) }}">more news</a></div>
    </div>
</section>
@endforeach
